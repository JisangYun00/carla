...
//
/**
 * Module:      CarlaEgoVehiclePhysicalStatusPublisher.cpp
...
#include "CarlaEgoVehiclePhysicalStatusPublisher.h"

namespace carla {
namespace ros2 {

bool CarlaEgoVehiclePhysicalStatusPublisher::Write(
    int32_t stamp_sec,
  ...
  msg->valid_signals = valid_signals & 0x1FFFu;
  return true;
}
